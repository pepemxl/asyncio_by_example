...
Muchas aplicaciones web dependen en gran medida de operaciones de E/S (entrada/salida), I/O en ingles. Este tipo de operaciones incluyen:
...
Para resolver este tipo de problemas fue introducida la librería **asyncio**  en Python 3.4 y aunque estaba proyectado resolver los problemas del GIL para python 3.12 con lo cual el trabajar con soluciones hibridas entre concurrencia y paralelismo será posible en python, esto aun no es del todo posible, aunque se ha avanzado bastante y se espera que en alguna de las proximas versiones este resuelto.
